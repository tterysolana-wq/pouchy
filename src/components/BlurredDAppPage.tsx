...
import { ArrowLeft, BarChart3, Users, TrendingUp, ExternalLink, BookOpen, Menu, X, Sparkles, Clock, Star } from 'lucide-react';
                ...
                <div className="relative text-center space-y-4 xs:space-y-6">
                  ...
                  <div className="space-y-3 xs:space-y-4">
                    ...
                    <p 
                      ...
                      style={{ fontFamily: 'Fredoka, system-ui, sans-serif' }}
                    >
                      We're working hard to bring you the most amazing Solana DApp experience. 
                      <span className="text-pink-600 font-medium"> Token analysis, wallet insights, and trending features</span> are coming very soon!
                    </p>
                  </div>
                  ...
                  <motion.p
                    ...
                    style={{ fontFamily: 'Fredoka, system-ui, sans-serif' }}
                  >
                    ✨ <span className="font-medium">Stay tuned!</span> Follow us for updates and be the first to know when we launch!
                  </motion.p>
                </div>
              </div>
            </motion.div>
