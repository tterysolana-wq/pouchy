                  ...
                  <div className="text-center space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <p
                        ...
                        style={{ fontFamily: "Fredoka, system-ui, sans-serif" }}
                      >
                        Connect your Solana wallet to access all DApp features
                        including token analysis, wallet overlap insights, and
                        CTO trending data.
                      </p>
                    </div>
                    ...
                    >
                      ...
                      can see the DApp interface in the background. Connect your
                      wallet to interact with all features.
                    </p>
                  </div>
                </div>
              </motion.div>
