  ...
  return (
    <header className="w-full px-4 py-4 sm:px-6 sm:py-6 md:px-9 md:py-9 flex items-center justify-between relative z-50 safe-area-inset-top">
      ...
      <div className="flex items-center gap-1 xs:gap-2 sm:gap-4 md:gap-6">
        <Button
          variant="secondary"
          className="bg-gradient-to-r from-pink-500/20 via-purple-500/20 to-blue-500/20 backdrop-blur-sm border-white/20 hover:bg-gradient-to-r hover:from-pink-500/30 hover:via-purple-500/30 hover:to-blue-500/30 hover:shadow-lg hover:shadow-pink-200/20 transition-all duration-200 text-xs xs:text-sm sm:text-base md:text-lg px-2 py-2 xs:px-3 xs:py-2 sm:px-4 sm:py-3 md:px-6 md:py-3 min-h-[44px] touch-manipulation text-purple-700 font-medium"
          onClick={handleLaunchpadClick}
        >
          <Rocket className="w-3 h-3 xs:w-4 xs:h-4 sm:w-5 sm:h-5 mr-1 xs:mr-1 sm:mr-2" />
          <span className="hidden xs:inline">Launchpad</span>
